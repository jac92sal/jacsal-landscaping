...
export default function App() {
  ...
  const generateAIAnalysis = (data: ScreeningOneData): AIAnalysis => {
    ...
    const alignmentTexts: Record<string, string> = {
      consulting: 'Your project aligns well with our strategic consulting services. We have extensive experience helping clients navigate complex business challenges.',
      design: 'Excellent match! Your creative needs align perfectly with our design team\'s expertise in creating compelling visual experiences.',
      development: 'Great fit! Your technical requirements match our engineering capabilities. We can help bring your vision to life.',
      marketing: 'Strong alignment with our marketing services. We can help you reach and engage your target audience effectively.',
      other: 'We can certainly help! Based on your description, we\'ll connect you with the right specialist from our team.',
    };
